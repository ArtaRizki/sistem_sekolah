...
class _SiswaScreenState extends State<SiswaScreen> {
  ...
  void _showSiswaDialog({Map<String, dynamic>? siswa}) {
    ...
    List<String> getClassesForSekolah(String sekolahNama) {
      final s = _sekolahList
          .where((element) => element['nama'] == sekolahNama)
          .firstOrNull;
      if (s == null) return [];
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    isExpanded: true,
                    initialValue: selectedKelas.isNotEmpty
                        ? selectedKelas
                        : null,
                    decoration: const InputDecoration(
                      labelText: 'Kelas',
                ...
                onPressed: () async {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          isEdit ? 'Siswa diperbarui' : 'Siswa ditambahkan',
                        ),
                      ),
                    );
                  }
            ...
            onPressed: () async {
              ...
              if (mounted) {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(const SnackBar(content: Text('Siswa dihapus')));
              }
            },
                    ...
                    child: _siswaList.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) =>
                                _buildSiswaCard(context, _siswaList[index]),
                          ),
                  ),
                ),
              ],
